    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <View style={styles.card}>
          ...
          <Text style={styles.title}>Join Smart Hall Booking</Text>
          <Text style={styles.subtitle}>Create an account only when you are ready to book.</Text>
          ...
          <TouchableOpacity
            onPress={() => router.replace(`/login?redirect=${encodeURIComponent(redirectPath)}`)}
            disabled={loading}
          >
